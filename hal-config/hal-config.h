...
#define BSP_LED1_PIN                         (0U)
#define BSP_LED1_PORT                        (gpioPortA)

#define BSP_LED2_PIN                         (0U)
#define BSP_LED2_PORT                        (gpioPortB)

#define BSP_LED3_PIN                         (5U)
#define BSP_LED3_PORT                        (gpioPortA)

#define BSP_LED4_PIN                         (2U)
#define BSP_LED4_PORT                        (gpioPortC)

#define BSP_LED_COUNT                        (5U)
#define BSP_LED_INIT                         { { BSP_LED0_PORT, BSP_LED0_PIN }, { BSP_LED1_PORT, BSP_LED1_PIN }, { BSP_LED2_PORT, BSP_LED2_PIN }, { BSP_LED3_PORT, BSP_LED3_PIN }, { BSP_LED4_PORT, BSP_LED4_PIN } }
#define HAL_LED_COUNT                        (5U)
#define HAL_LED_ENABLE                       { 0, 1, 2, 3, 4 }
...
#define HAL_SERIAL_IDLE_WAKE_ENABLE          (0)
#define HAL_SERIAL_USART0_ENABLE             (0)
#define HAL_SERIAL_USART1_ENABLE             (0)
#define HAL_SERIAL_USART2_ENABLE             (0)
#define HAL_SERIAL_APP_TYPE                  (HAL_VUART_TYPE_SWO)
#define HAL_SERIAL_ASSERT_TYPE               (HAL_VUART_TYPE_SWO)
// [SERIAL]$
...
// $[Custom pin names]
#define OFF_LED1_PIN                         (0U)
#define OFF_LED1_PORT                        (gpioPortA)

#define RELAY1_PIN                           (4U)
#define RELAY1_PORT                          (gpioPortA)

#define OFF_LED2_PIN                         (5U)
#define OFF_LED2_PORT                        (gpioPortA)

#define COMMISSIONING_STATUS_LED_PIN         (2U)
#define COMMISSIONING_STATUS_LED_PORT        (gpioPortC)
